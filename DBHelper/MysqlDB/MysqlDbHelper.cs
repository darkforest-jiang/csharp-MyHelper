...
namespace DBHelper.MysqlDB
{
    ...
    public class MysqlDbHelper : DbHelperBase
    {
        ...
        /// <returns></returns>
        public DbExecMsg TLGetInfo<T>(CommandType cmdType, string cmdText, ref SortedList<string, MySqlParameter> sqlParms, out T tInfo) where T : new()
        {
            DbExecMsg execMsg = new DbExecMsg();
            execMsg.IsSuccess = true;
            execMsg.ErrType = false;
        ...
        /// <returns></returns>
        public DbExecMsg TLGetInfo<T>(CommandType cmdType, string cmdText, ref SortedList<string, MySqlParameter> sqlParms, out List<T> tInfo) where T : new()
        {
            DbExecMsg execMsg = new DbExecMsg();
            execMsg.IsSuccess = true;
            execMsg.ErrType = false;
        ...
        /// <param name="sqlParms">参数</param>
        /// <returns></returns>
        public DbExecMsg TOpData(CommandType cmdType, string cmdText, ref SortedList<string, MySqlParameter> sqlParms)
        {
            DbExecMsg execMsg = new DbExecMsg();
            execMsg.IsSuccess = true;
            execMsg.ErrType = false;
        ...
        /// <returns></returns>
        public DbExecMsg TOpListData(CommandType cmdType, string cmdText, ref List<SortedList<string, MySqlParameter>> sqlParms)
        {
            DbExecMsg execMsg = new DbExecMsg();
            execMsg.IsSuccess = true;
            execMsg.ErrType = false;
            ...
            using (MysqlDbOp dbOp = new MysqlDbOp(ConnStr))
            {
                try
                {
                    ...
                    foreach (var spItems in sqlParms)
                    {
                        ...
                        {
                            dbOp.DbCmdParm.MysqlParms.Add(pnItem, spItems[pnItem]);
                        }
